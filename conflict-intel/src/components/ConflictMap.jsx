...
// Custom pulsing dot icon for active incident markers
...
const mapEvents = [
  {
    ...
    lat: 48.35,
    lng: 31.17,
    headline: 'Artillery exchanges reported along eastern front lines',
    region: 'Ukraine',
    severity: 'high',
  ...
  },
  {
    ...
    lat: 32.08,
    lng: 34.78,
    headline: 'Heightened air defense activity observed over central region',
    region: 'Israel / Gaza',
    severity: 'high',
  ...
  },
  {
    ...
    lat: 15.35,
    lng: 42.76,
    headline: 'Commercial shipping rerouting as naval threat persists',
    region: 'Red Sea',
    severity: 'medium',
  ...
  },
  {
    ...
    lat: 33.87,
    lng: 35.49,
    headline: 'Cross-border fire incidents logged in southern sector',
    region: 'Lebanon',
    severity: 'medium',
  ...
  },
  {
    ...
    lat: 24.88,
    lng: 67.09,
    headline: 'Maritime surveillance uptick near strategic chokepoint',
    region: 'Arabian Sea',
    severity: 'low',
    source: 'Satellite Feed',
  },
  {
    ...
    lat: 35.69,
    lng: 139.69,
    headline: 'Increased carrier group activity in contested waters',
        ...
        >
          ...
          {mapEvents.map((event) => (
            <Marker
              ...
              icon={createIncidentIcon(event.severity)}
            >
              <Popup
                closeButton={false}
